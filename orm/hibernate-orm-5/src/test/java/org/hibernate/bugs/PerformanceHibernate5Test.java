 ...
 */
@State(Scope.Thread)
public class PerformanceHibernate5Test {
	...
	public static void main(String[] args) throws RunnerException, IOException {
		if (args.length == 0) {
			final Options opt = new OptionsBuilder()
					...
					.include(PerformanceHibernate5Test.class.getSimpleName())
					.warmupIterations(3)
	...
	@Benchmark
	public void h5_no_extra_query(Blackhole blackhole) {
	...
	@Benchmark
	public void h5_with_hitting_extra_query(Blackhole blackhole) {
	...
	@Benchmark
	public void h5_with_not_hitting_extra_query(Blackhole blackhole) {
	...
	private void queryAccessForEmployee( Blackhole blackhole, EntityManager entityManager, Employee employee, boolean extraQueryHits) {
		...
		accessList.forEach(p -> blackhole.consume(p));
